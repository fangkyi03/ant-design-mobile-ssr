...
var NumberInput = function (_React$Component) {
    ...
    _createClass(NumberInput, [{
        ...
        value: function getComponent() {
            ...
            return React.createElement(CustomKeyboard, { ref: this.saveRef, onClick: this.onKeyboardClick, prefixCls: keyboardPrefixCls, confirmLabel: confirmLabel, backspaceLabel: backspaceLabel, cancelKeyboardLabel: cancelKeyboardLabel, wrapProps: moneyKeyboardWrapProps, header: moneyKeyboardHeader });
        }
    }, {
        key: 'getContainer',
